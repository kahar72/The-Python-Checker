# 📺 IPTV Health Report
**Last Checked:** 2026-03-17 02:29:10 (SGT)
...
| Astro Ria 🇲🇾 | ❌ Offline | DASH (.mpd) | Error 400 |
| Astro Ria 🇲🇾 | ❌ Offline | DASH (.mpd) | Error 404 |
| Astro Prima 🇲🇾 | ❌ Offline | DASH (.mpd) | Error 400 |
| Astro Prima 🇲🇾 | ✅ Online | DASH (.mpd) | 200 OK |
...
| Astro QJ 🇲🇾 | ⚠️ Restricted | DASH (.mpd) | 403 (Requires Key/Token) |
...
| NOW Sports PL 4 🇭🇰 | ✅ Online | HLS (.m3u8) | 200 OK |
| USA Network East 🇺🇲 | ✅ Online | HLS (.m3u8) | 200 OK |
| NBC 🇺🇲 | ✅ Online | HLS (.m3u8) | 200 OK |
...
| Astro Arena Bola 🇲🇾 | ❌ Offline | DASH (.mpd) | Error 404 |
| Astro Arena Bola 2 🇲🇾 | ❌ Offline | DASH (.mpd) | Error 404 |
...
| Premier Sport Asia 🇲🇾 | ⚠️ Restricted | DASH (.mpd) | 403 (Requires Key/Token) |
...
| Sportsnet East 🇨🇦 | ⚠️ Restricted | HLS (.m3u8) | 403 (Requires Key/Token) |
...
| TSN 5 🇨🇦 | ⚠️ Restricted | HLS (.m3u8) | 403 (Requires Key/Token) |
| Eleven Sports 1 🇵🇹 | ⚠️ Restricted | HLS (.m3u8) | 403 (Requires Key/Token) |
